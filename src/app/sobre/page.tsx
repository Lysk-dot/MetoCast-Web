    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-lg text-foreground-secondary max-w-2xl mx-auto leading-relaxed">
          ...
          <strong className="text-foreground">Universidade Metodista</strong> para discutir
      ...
      {/* Social Links */}
      <section className="text-center space-y-6">
        <h2 className="font-heading text-2xl font-bold text-foreground">Nos acompanhe</h2>
