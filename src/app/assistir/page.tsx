            ...
            >
              ...
              <div className="p-5 flex items-center justify-between gap-4">
                <div className="min-w-0">
                  <h2 className="font-heading font-semibold text-white truncate">
                    {episode.title}
                  </h2>
                ...
                <Link
                  ...
                  className="flex-shrink-0 inline-flex items-center gap-2 px-4 py-2 bg-primary-yellow text-surface-darkest font-semibold rounded-lg hover:brightness-110 transition-all text-sm"
                >
                  <Play size={14} />
                  Detalhes
                </Link>
