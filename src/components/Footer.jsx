...
const Footer = () => {
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/meto_cast/',
      icon: (
    ...
    {
      name: 'Spotify',
      url: 'https://open.spotify.com/show/1QpRW5ISZzqqJyd3orYxsy',
      icon: (
        <svg style={{ width: '24px', height: '24px' }} viewBox="0 0 24 24" fill="currentColor">
    ...
    // YouTube link desabilitado
    // {
    //   name: 'YouTube',
    //   url: 'https://www.youtube.com/@MetoCast',
    //   icon: (
    //     <svg style={{ width: '24px', height: '24px' }} viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={styles.grid}>
          ...
          <div style={styles.logoSection}>
            ...
            <p style={styles.description}>
              PodCast oficial dos alunos da Metodista.
              <br />
              Futuro, educação, voz, histórias e mais.
            </p>
          </div>
